...
function exp_label_Sites_3_eval_expression(context) {
    ...
    if (feature.properties) {
        return fnc_if([(fnc_var(['layout_name'], context) == 'Sites Poster'),feature.properties['display_name'] ,feature.properties['Name'] ], context);
    } else {
        return fnc_if([(fnc_var(['layout_name'], context) == 'Sites Poster'),feature['display_name'] ,feature['Name'] ], context);
    }
}
